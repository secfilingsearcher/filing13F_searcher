...
from database_connection import insert_in_database_infotable_table, insert_in_database_primary_table
...
from primary_key_generator import pk_generator_for_primary_doc
...
def main():
    ...
    for filing_detail_url in filing_detail_urls:
        ...
        primary_doc_primary_key = pk_generator_for_primary_doc([cik, company_name, filing_date])
