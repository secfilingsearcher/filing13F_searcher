...
def test_parse_13f_filing_detail_urls(current_events_text):
    ...
    actual = parse_13f_filing_detail_urls(current_events_text)

    assert actual == ['https://www.sec.gov/Archives/edgar/data/1850858/0001850858-21-000001-index.html',
...
def test_parse_sec_accession_no(filing_detail_text):
    ...
    actual = parse_sec_accession_no(filing_detail_text)
...
def test_parse_primary_doc_xml_and_infotable_xml_urls(filing_detail_text):
    ...
    actual = parse_primary_doc_xml_and_infotable_xml_urls(filing_detail_text)

    assert actual == ['/Archives/edgar/data/1852858/000185285821000001/primary_doc.xml',
...
def test_parse_primary_doc_xml_url(xml_list):
    ...
    actual = parse_primary_doc_xml_url(xml_list)
...
def test_parse_infotable_xml_url(xml_list):
    ...
    actual = parse_infotable_xml_url(xml_list)
