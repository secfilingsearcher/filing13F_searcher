...
def client():
    ...
    with app.test_client() as client:
        with app.app_context():
            ...
            edgar_filing1_row1 = EdgarFiling(accession_no=ACCESSION_NO_TABLE1_ROW1,
                                             cik_no=COMPANY_CIK_1,
                                             filing_date=datetime.fromisoformat("1999-09-01"))
            edgar_filing1_row2 = EdgarFiling(accession_no=ACCESSION_NO_TABLE1_ROW2,
                                             cik_no=COMPANY_CIK_1,
                                             filing_date=datetime.fromisoformat("1998-05-02"))
            data_13f1_row1 = Data13f(equity_holdings_id="67896567",
            ...
            data_13f1_row2 = Data13f(equity_holdings_id="673326567",
            ...
            data_13f2 = Data13f(equity_holdings_id="4364347",
            ...
            data_13f3 = Data13f(equity_holdings_id="39023347",
            ...
            db.session.add(data_13f1_row1)
            db.session.add(data_13f1_row2)
            db.session.add(data_13f2)
            db.session.add(data_13f3)
            db.session.commit()
        yield client
