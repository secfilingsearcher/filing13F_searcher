...
class Data13f(db.Model):
    ...
    # equity_holdings_id: id of equity holdings. Generated by the function create_data_13f_primary_key
    ...
    # voting_authority_shared: number of shares for which the Manager exercises shared voting authority
